    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-6 py-10 lg:px-10 lg:py-14">
      <section className="rounded-[2rem] border border-border bg-card/80 p-7 shadow-sm">
        ...
        <p className="mt-4 max-w-3xl text-base leading-8 text-muted-foreground">
          The 25 most-installed skills in SkillJury&apos;s verified recovery
          snapshot, ordered by weekly install volume. Live rankings will resume
          when catalog sync is restored.
        </p>
      ...
      <section
        aria-label="Top-rated recovery catalog"
